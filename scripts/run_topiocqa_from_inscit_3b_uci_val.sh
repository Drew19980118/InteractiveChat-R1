#!/usr/bin/env bash
# Transfer evaluation: InsCiT-trained Qwen2.5-3B checkpoint -> TopiOCQA online test.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_topiocqa_from_inscit_3b_uci_step14}"
