#!/usr/bin/env bash
# Canonical InteractiveChat-R1: QReCC Qwen2.5-3B, F1 + user satisfaction.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_qrecc_3b_full_f1_satisfaction_30steps}"
