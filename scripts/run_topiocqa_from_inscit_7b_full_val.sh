#!/usr/bin/env bash
# Transfer: InsCiT-trained Qwen2.5-7B full checkpoint -> TopiOCQA online test.
set -euo pipefail
...
export CHECKPOINT_PATH="${CHECKPOINT_PATH:-$PROJECT_ROOT/outputs/inscit/interactivechat_r1_inscit_7b_full_f1_satisfaction_15steps/global_step_14}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_topiocqa_from_inscit_7b_full_f1_satisfaction_step14}"
