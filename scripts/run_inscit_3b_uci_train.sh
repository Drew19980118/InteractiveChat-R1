#!/usr/bin/env bash
# Canonical InteractiveChat-R1 run: InsCiT train -> InsCiT online test, Qwen2.5-3B.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_inscit_3b_uci_15steps}"
