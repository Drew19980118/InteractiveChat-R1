...
SIMULATED_USER_ENABLE_EVIDENCE_UTILITY="${SIMULATED_USER_ENABLE_EVIDENCE_UTILITY:-true}"
SIMULATED_USER_ENABLE_SEARCH_EFFICIENCY="${SIMULATED_USER_ENABLE_SEARCH_EFFICIENCY:-true}"
...
echo "[SimUser Train] feedback=$SIMULATED_USER_ENABLE_FEEDBACK passive_satisfaction_eval=$SIMULATED_USER_PASSIVE_SATISFACTION_EVALUATION static_gold_context=$SIMULATED_USER_STATIC_GOLD_CONTEXT evidence_utility=$SIMULATED_USER_ENABLE_EVIDENCE_UTILITY search_efficiency=$SIMULATED_USER_ENABLE_SEARCH_EFFICIENCY"
if [[ -n "$SIMULATED_USER_VALIDATION_MAX_BATCHES" ]]; then
