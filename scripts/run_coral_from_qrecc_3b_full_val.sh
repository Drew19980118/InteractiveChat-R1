#!/usr/bin/env bash
# Transfer: QReCC-trained Qwen2.5-3B full checkpoint -> CoRAL online test.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_coral_from_qrecc_3b_full_f1_satisfaction_step29}"
