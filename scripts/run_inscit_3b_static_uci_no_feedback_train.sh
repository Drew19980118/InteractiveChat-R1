...
# are disabled. Answer-F1, action, format, and clarification-F1 remain active.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-sim_user_inscit_3b_static_no_feedback_f1_15steps}"
