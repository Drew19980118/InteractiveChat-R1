...
# Main proposed reward: UCI plus interactive task/user channels.  The
# evidence-only and efficiency experiments are deliberately off in the
# canonical recipe used by the paper runs.
...
export SIMULATED_USER_ANSWER_F1_WEIGHT="${SIMULATED_USER_ANSWER_F1_WEIGHT:-0.0}"
...
export SIMULATED_USER_UCI_WEIGHT="${SIMULATED_USER_UCI_WEIGHT:-1.0}"
