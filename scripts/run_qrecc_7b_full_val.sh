#!/usr/bin/env bash
# Evaluate a QReCC-trained Qwen2.5-7B full checkpoint on QReCC online test.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_qrecc_7b_full_f1_satisfaction_step29_val}"
