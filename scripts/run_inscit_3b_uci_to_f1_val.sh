#!/usr/bin/env bash
# Standalone online validation for the controlled UCI-to-answer-F1 ablation.
set -euo pipefail
...
export CHECKPOINT_PATH="${CHECKPOINT_PATH:-$PROJECT_ROOT/outputs/inscit/sim_user_inscit_3b_uci_to_f1_15steps/global_step_14}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-sim_user_inscit_3b_uci_to_f1_step14_val}"
