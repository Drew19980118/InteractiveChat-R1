#!/usr/bin/env bash
# Transfer evaluation: QReCC-trained Qwen2.5-7B checkpoint -> CoRAL online test.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_coral_from_qrecc_7b_uci_step29}"
