#!/usr/bin/env bash
# Evaluate an InsCiT-trained Qwen2.5-7B full checkpoint on InsCiT online test.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_inscit_7b_full_f1_satisfaction_step14_val}"
