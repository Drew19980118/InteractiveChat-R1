...
export CHECKPOINT_PATH="${CHECKPOINT_PATH:-$PROJECT_ROOT/outputs/inscit/sim_user_inscit_3b_static_uci_no_feedback_15steps/global_step_14}"
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-sim_user_inscit_3b_static_uci_no_feedback_step14_val}"
