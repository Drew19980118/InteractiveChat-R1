#!/usr/bin/env bash
# Re-evaluate a QReCC-trained Qwen2.5-3B FSDP checkpoint on QReCC online test.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_qrecc_3b_uci_step29_val}"
