#!/usr/bin/env bash
# Canonical InteractiveChat-R1: InsCiT Qwen2.5-7B, F1 + user satisfaction.
set -euo pipefail
...
export EXPERIMENT_NAME="${EXPERIMENT_NAME:-interactivechat_r1_inscit_7b_full_f1_satisfaction_15steps}"
