...
#             print(f"{key}: {value}")
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            # vLLM 0.6.3 uses the customized rollout and only exports
            # vLLMRollout.  Importing vLLMAsyncRollout here unconditionally
            # breaks even synchronous rollouts before mode selection.
